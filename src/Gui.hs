...
renderClientScript guiData =
    unlines
        ...
        , "};"
        , "const awayKitColors = {"
        , "  ARS: '#f8fafc', AVL: '#38bdf8', BOU: '#f8fafc', BRE: '#facc15', BHA: '#f97316', CHE: '#f8fafc', CRY: '#facc15', EVE: '#facc15', FUL: '#111827', IPS: '#f43f5e', LEI: '#facc15', LIV: '#14b8a6', MCI: '#7c2d12', MUN: '#f8fafc', NEW: '#38bdf8', NFO: '#facc15', SOU: '#facc15', TOT: '#0f172a', WHU: '#f8fafc', WOL: '#14b8a6'"
        , "};"
